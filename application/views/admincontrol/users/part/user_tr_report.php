...
foreach ($userslist as $users) {  ?>
	...
	<tr>
		...
		<td>
			...
			<a data-toggle="tooltip" title="<?= __('admin.view_downline') ?>" href="<?= base_url('admincontrol/downline/' . $users['id']) ?>" class="btn btn-primary btn-sm"> <i class="fa fa-eye"></i> </a>

			<button data-toggle="tooltip" title="<?= __('admin.quick_view_downline') ?>" data-id="<?php echo $users['id'] ?>" class="btn show-tree btn-info btn-sm"> <i class="fa fa-sitemap"></i> </button>

			<a data-toggle="tooltip" title="<?= __('admin.edit') ?>" class="btn btn-sm btn-primary" onclick="return confirmpopup('<?php echo base_url(); ?>admincontrol/addusers/<?php echo $users['id']; ?>');" href="javascript:void(0)">
				<i class="fa fa-edit cursors" aria-hidden="true"></i>
			</a>

			<button data-toggle="tooltip" title="<?= __('admin.payment_details') ?>" class="btn btn-sm btn-primary " payment_detail="<?php echo $users['id'] ?>"><i class="fa fa-info-circle" aria-hidden="true"></i></button>

			<button data-toggle="tooltip" title="<?= __('admin.delete') ?>" class="btn btn-sm btn-danger btn-delete2" data-id="<?php echo $users['id'] ?>">
				<i class="fa fa-trash-o cursors" aria-hidden="true"></i>
			</button>

			<?php if ($users['status']) { ?>

				<a data-toggle="tooltip" title="<?= __('admin.disable_status') ?>" href="<?= base_url('admincontrol/u_status_toggle/' . $users["id"]) ?>" class="btn btn-remove btn-primary btn-sm"><i class="fa fa-lock"></i></a>

			<?php } else { ?>

				<a data-toggle="tooltip" title="<?= __('admin.enable_status') ?>" href="<?= base_url('admincontrol/u_status_toggle/' . $users["id"]) ?>" class="btn btn-remove btn-danger btn-sm"><i class="fa fa-unlock"></i></a>

			<?php } ?>

			<button data-toggle="tooltip" title="<?= __('admin.login') ?>" class="btn btn-sm btn-success btn-login-aff" data-id="<?php echo $users['id'] ?>"><i class="fa fa-sign-in" aria-hidden="true"></i></button>
