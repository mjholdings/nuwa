...
baseBuilderElements.push({
	name: 'paragraph',
 	frameworks: ['base'],
 	nodes: ['p'],
 	html: '<p>Nuwa dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor '+
...
baseBuilderElements.push({
	name: 'blockqoute',
 	...
 	nodes: ['blockqoute'],
 	html: '<blockquote>'+
  		    '<p>Nuwa dolor sit amet, consectetur adipiscing elit. Integer posuere erat a ante.</p>'+
