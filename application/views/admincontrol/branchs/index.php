    ...
    <div class="card">
      <div class="card-header bg-secondary text-white">
        <div class="d-flex justify-content-between align-items-center">
          <h5><?= __('admin.store_branchs') ?></h5>
          <div>
            <a id="toggle-uploader" class="btn btn-light" href="<?php echo base_url("admincontrol/addbranch") ?>">
              <?= __('admin.add_branch') ?></a>
          </div>
        </div>
      </div>
      <div class="card-body">
...
<script>
    ...
    $.ajax({
    url: "<?= base_url('admincontrol/listbranchs'); ?>/" + page,
    type: 'POST',
    dataType: 'json',
    data: {
      listbranchs: 1,
