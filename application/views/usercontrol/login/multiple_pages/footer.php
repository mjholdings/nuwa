            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section-title text-center">
                        ...
                        <h2><?= (isset($footer->banner_bottom_title) && !empty($footer->banner_bottom_title)) ? $footer->banner_bottom_title : "What is NuwaS?" ?></h2>
                        <p><?= (isset($footer->banner_bottom_slug) && !empty($footer->banner_bottom_slug)) ? $footer->banner_bottom_slug : "Nuwa is simply dummy text of the printing and typesetting industry." ?></p>
                        <a class="front_button_color front_button_hover_color front_button_text_color" href="<?= $footer->banner_button_link ?>"><?= (isset($footer->banner_button_text) && !empty($footer->banner_button_text)) ? $footer->banner_button_text : "Nuwa" ?></a>
                    </div>
                </div>
            </div>
        </div>
