...
function withdrwal_status($status) {
    ...
    switch ((int)$status) {
        case 0:
            $label = '<span class="badge bg-secondary text-light px-3 py-2 fs-6">' . __('admin.received') . '</span>';
            break;
        case 13:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.pending') . '</span>';
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.paid') . '</span>';
            break;
        case 2:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.total_not_match') . '</span>';
            break;
        case 3:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.denied') . '</span>';
            break;
        case 4:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.expired') . '</span>';
            break;
        case 5:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.failed') . '</span>';
            break;
        case 6:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.pending') . '</span>';
            break;
        case 7:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.processed') . '</span>';
            break;
        case 8:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.refunded') . '</span>';
            break;
        case 9:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.reversed') . '</span>';
            break;
        case 10:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.voided') . '</span>';
            break;
        case 11:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.cancel_reversal') . '</span>';
            break;
        case 12:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.waiting_for_payment') . '</span>';
            break;
        default:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.unknown') . '</span>';
            break;
    }
...
function membership_withdrwal_status($status) {
    ...
    switch ((int)$status) {
        case 0:
            ...
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.active') . '</span>';
            break;
        case 2:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.total_not_match') . '</span>';
            break;
...
function store_withdrwal_status($status) {
    ...
    switch ((int)$status) {
        case 0:
            $label = '<span class="badge bg-secondary text-light px-3 py-2 fs-6">' . __('admin.waiting_for_payment') . '</span>';
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.complete') . '</span>';
            break;
        case 2:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.total_not_match') . '</span>';
            break;
...
function ads_status($status) {
    ...
    switch ((int)$status) {
        case 0:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.draft') . '</span>';
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.public') . '</span>';
            break;
        case 2:
            $label = '<span class="badge bg-info text-light px-3 py-2 fs-6">' . __('admin.in_review') . '</span>';
            break;
        default:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.unknown') . '</span>';
            break;
...
function ads_security_status($status) {
    ...
    switch ((int)$status) {
        case 0:
            $label = '<span class="badge bg-info text-light px-3 py-2 fs-6">' . __('admin.pending_integration') . '</span>';
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.approved') . '</span>';
            break;
        default:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.unknown') . '</span>';
            break;
...
function ads_google_status($status) {
    ...
    switch ((int)$status) {
        case 1:
            $label =  __('admin.side_bar_top');
            break;
        case 2:
            $label = __('admin.side_bar_bottom');
            break;
        case 3:
            $label = __('admin.footer');
            break;
        case 4:
            $label = __('admin.right_side');
            break;
        case 5:
            $label = __('admin.center_page');
            break;
        default:
            $label = __('admin.right_side');
            break;
...
function program_status($status) {
    ...
    switch ((int)$status) {
        case 0:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.in_review') . '</span>';
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.approved') . '</span>';
            break;
        case 2:
            ...
            break;
        case 3:
            $label = '<span class="badge bg-yellow text-dark px-3 py-2 fs-6">' . __('admin.ask_to_edit') . '</span>';
            break;
        default:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.unknow') . '</span>';
            break;
    }
    return $label;
}
...
function product_status_on_store($status) {
    ...
    switch ((int)$status) {
        case 0:
            $label = '<span class="badge bg-danger text-light px-3 py-2 fs-6">' . __('admin.not_displayed') . '</span>';
            break;
        case 1:
            $label = '<span class="badge bg-success text-light px-3 py-2 fs-6">' . __('admin.displayed') . '</span>';
            break;
        default:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">' . __('admin.unknow') . '</span>';
            break;
...
function form_status($status) {
    ...
    switch ((int)$status) {
        ...
        case 3:
            ...
            break;
        default:
            $label = '<span class="badge bg-warning text-light px-3 py-2 fs-6">Unknow</span>';
            break;
    }
    return $label;
}
...
function e3DpOIO10($check_cache = true) {
    ...
    if ($res && isset($res['success'])) {
        ...
        @unlink($cache_file);
        header('location:' . base_url('install/index.php?error=' . $res['error']));
        die;
    }
}
...
// Trạng thái trả vào ví
function wallet_paid_status($status) {
    $html = '';
    switch ($status) {
        case '0':
            return "<span class='badge bg-secondary text-light px-3 py-2 fs-6'>" . __('admin.not_paid') . "</span>";
            break;
        case '1':
            return "<span class='badge bg-secondary text-light px-3 py-2 fs-6'>" . __('admin.not_paid') . "</span>";
            break;
        case '2':
            return "<span class='badge bg-primary text-light px-3 py-2 fs-6'>" . __('admin.in_request') . "</span>";
            break;
        case '3':
            return "<span class='badge bg-success text-light px-3 py-2 fs-6'>" . __('admin.paid') . "</span>";
            break;
        case '4':
            return "<span class='badge bg-danger text-light px-3 py-2 fs-6'>" . __('admin.declined') . "</span>";
            break;
        default:
            return "<span></span>";
            break;
...
function commission_status($status) {
    ...
    switch ($status) {
        case '1':
            return "<span class='badge bg-warning text-light px-3 py-2 fs-6'>" . __('admin.canceled') . "</span>";
            break;
        case '2':
            return "<span class='badge bg-danger text-light px-3 py-2 fs-6'>" . __('admin.trashed') . "</span>";
            break;
        default:
            return "<span></span>";
            break;
...
// Kiểm tra xem hoa hồng đến từ ai cho AFF
...
// Kiểm tra xem hoa hồng đến từ ai người bán
