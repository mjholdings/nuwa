...
if ($userdetails['reg_approved'] != 1 && !isset($notcheckapproval)) {
  redirect('usercontrol/approval_status');
  die;
}
if ($MembershipSetting['status']) {
  ...
  if ((int)$user->plan_id == 0) {
    if (!isset($notcheckmember)) {
      redirect('usercontrol/purchase_plan');
      die;
    }
        ...
        <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="<?= base_url('/'); ?>">
              <i class="fa-sharp fa-solid fa-home icon pt-1"></i>
              <span class="item-name"><?= __('Trang chủ') ?></span>
            </a>
          </li>
          <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  ...
                  <div class="caption ms-3 d-md-block ">
                    ...
                    <h6 class="mb-0 caption-title"><?= __('user.welcome_user') ?> <strong><?= $loginUser['username'] ?></strong>
                      <?php if ($loginUser['user_star'] == 3) { ?>
                        <br><small>
                          <i class="fa fa-star" aria-hidden="true"></i>
                          <i class="fa fa-star" aria-hidden="true"></i>
                          <i class="fa fa-star" aria-hidden="true"></i>
                        </small>
                      <?php } else if ($loginUser['user_star'] == 4) { ?>
                        <br><small>
                          <i class="fa fa-star" aria-hidden="true"></i>
                          <i class="fa fa-star" aria-hidden="true"></i>
                          <i class="fa fa-star" aria-hidden="true"></i>
                      ...
                      <?php } else if ($loginUser['user_star'] == 5) { ?>
                        <br><small>
                          <i class="fa fa-star" aria-hidden="true"></i>
                          <i class="fa fa-star" aria-hidden="true"></i>
                          <i class="fa fa-star" aria-hidden="true"></i>
