	...
	<tr>
		...
		<td>
			...
			<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
				<a class="dropdown-item btn btn-sm btn-danger" onclick="if(!confirm('<?= __('admin.are_you_sure') ?>')) return false" href="<?= base_url('admincontrol/store_category_delete/' . $category['id']) ?>"><?= __('admin.delete') ?></a>
			</div>
		</td>
	</tr>
