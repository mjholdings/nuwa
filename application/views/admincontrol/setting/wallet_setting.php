<div class="card">
	...
	<div class="card-body">
		<form class="row g-3" method="post" action="" enctype="multipart/form-data" id="setting-form">
			<div class="col-12">
				<h4>Cài đặt Rút tiền:</h4>
				<div class="row">
					<div class="col-sm-4 withdrawal_to_wallet_panel">
						<div class="mb-3">
				...
				<div class="row">
					...
					<div class="col-sm-6 mb-3" id="wallet_min_message_panel">
						<label class="form-label"><?= __('admin.minimum_withdraw_message') ?></label>
						<input name="site[wallet_min_message_new]" class="form-control" value="<?= $site['wallet_min_message_new'] != '' ? $site['wallet_min_message_new'] : __('Giới hạn rút tối thiểu là'); ?>" />
					</div>
				</div>
				<div class="row">
					<div class="col-sm-4 mb-3">
					...
					<div class="col-sm-4 mb-3" id="wallet_min_message_panel">
						<label class="form-label"><?= __('Thông điệp cảnh báo rút tiền tối đa') ?></label>
						<input name="site[wallet_max_message_new]" class="form-control" value="<?= $site['wallet_max_message_new'] != '' ? $site['wallet_max_message_new'] : __('Giới hạn rút tối đa là'); ?>" />
					</div>
				</div>
				<h4>Thưởng nạp tiền:</h4>
				<div class="row">
					<div class="col-sm-6 mb-3">
					...
					<div class="col-sm-6">
						<label class="form-label"><?= __('Giá trị thêm % số tiền nạp / thêm số tiền cụ thể') ?></label>
