...
<div class="row gx-3 gy-3 wallet-page">
	<div class="col-xl-4 d-flex">
		<div class="card flex-fill">
			<div class="card-header bg-primay text-white text-center text-uppercase">
	...
	<!--          <ul class="list-inline row mb-0 clearfix">-->
	<!--            <li class="col-12">-->
	<!--              <p class="m-b-5 counter">--><? //= (int)$admin_totals['click_action_total'] 
													?><!-- / --><? //= c_format($admin_totals['click_action_commission']) 
																?><!--</p>-->
	<!--              <p class="mb-0 text-muted">--><? //= __('admin.all_actions') 
													?><!--</p>-->
	<!--            </li>-->
	<!--          </ul>-->
	<!--        </div>-->
	...
	<!--                --><? //= c_format(
							...
							?>
	<!--              </p>-->
	<!--              <p class="mb-0 text-muted">--><? //= __('admin.all_clicks') 
													?><!--</p>-->
	<!--            </li>-->
	<!--          </ul>-->
	<!--        </div>-->
...
<script type="text/javascript">
	...
	$("#modal-confirm .modal-body").delegate("[delete-mmultiple-confirm]", "click", function() {
		...
		$.ajax({
			...
			dataType: 'json',
			data: {
				id: $this.attr("delete-mmultiple-confirm")
			},
			beforeSend: function() {
				$this.button("loading");
			},
