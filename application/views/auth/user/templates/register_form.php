	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title fw-bold" id="successModalLabel">Thông báo</h5>
			</div>
			<div class="modal-body">
				<h4 class="modal-subtitle fw-bold">Đăng ký tài khoản thành công!</h4>
				<p>Chúc mừng bạn đã trở thành thành viên của hệ thống. Cảm ơn và chúc quý đối tác bắt đầu khởi sự kinh doanh cùng tập đoàn MEGA!</p>
			</div>
			<div class="modal-footer d-flex justify-content-center">
				<button type="button" class="btn btn-success" data-dismiss="modal" id="closeSuccessModal">Đóng</button>
			</div>
		</div>
	</div>
</div>
					...
					success: function(json) {
						...
						if (json['errors']) {
							$.each(json['errors'], function(i, j) {
								...
								if (i == 'terms') {
									$(".reg-agree-label").after("<span class='invalid-feedback'>" + j + "</span>");
									return true;
								}
