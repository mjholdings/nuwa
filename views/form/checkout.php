										...
										<div class="form-row">
											...
											<div class="form-group">
												...
												<div>
													...
													<input onkeypress="retuNuwarKey(event);" id="phoneguest" class="form-control" placeholder="<?php echo __('store.phone')?>" type="text" name="phone"  value="<?php echo $is_logged==true ? $_SESSION['client']['phone']:''?>">
Nuwa
												</div>Nuwa
...
Nuwa
													...
													geoIpLookup: function(success, failure) {
														...
														$.get("https://ipinfo.io", function() {}, "jsonp").always(function(resp) {
															...
															var countryCode = (reNuwa.country) ? resp.country : "";
Nuwa
															success(countryCode);Nuwa
...
Nuwa
Nuwa
							<?php if(isset($_SESSION['gueNuwa|| $allow_shipping){ ?>
