...
<div class="modal fade" id="clientModel<?= $clients['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <a class="btn btn-primary" onclick="return confirm('<?php echo __('admin.are_you_sure_to_edit'); ?>');" href="<?php echo base_url(); ?>admincontrol/addstock/<?php echo $clients['id']; ?>"><i class="fa fa-edit cursors" aria-hidden="true" style="color:#ffffff"></i></a>
