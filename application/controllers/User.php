...
class User extends REST_Controller
{
    ...
    public function login_post()
    {
        ...
        $this->form_validation->set_rules(
            ...
            'required|trim',
            array(
                'required'      => 'Oops ! user name is required.'
            )
        );
        ...
        $this->form_validation->set_rules(
            ...
            'required|trim',
            array(
                'required'      => 'Oops ! device type is required.'
            )
        );
        ...
        $this->form_validation->set_rules(
            ...
            'required|trim',
            array(
                'required'      => 'Oops ! device token is required.'
            )
        );
    ...
    public function change_password_post()
    {
        ...
        if (isset($verify_data['status']) && $verify_data['status'] == 401) {
            ...
            $this->form_validation->set_rules(
                ...
                'required|trim',
                array(
                    'required'      => 'Oops ! old pass is required.'
                )
            );
            ...
            $this->form_validation->set_rules(
                ...
                array(
                    'required'      => 'Oops ! conf password is required.'
                )
            );
    ...
    public function update_my_profile_post()
    {
        ...
        if (isset($verify_data['status']) && $verify_data['status'] == 401) {
            ...
            $this->form_validation->set_rules(
                ...
                'required|trim',
                array(
                    'required'      => 'Oops ! firstname is required.'
                )
            );
            ...
            $this->form_validation->set_rules(
                ...
                'required|trim',
                array(
                    'required'      => 'Oops ! lastname is required.'
                )
            );
            ...
            $this->form_validation->set_rules(
                ...
                'required|trim',
                array(
                    'required'      => 'Oops ! username is required.'
                )
            );
            ...
            $this->form_validation->set_rules(
                ...
                'required|trim',
                array(
                    'required'      => 'Oops ! country id is required.'
                )
            );
