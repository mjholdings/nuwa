...
Nuwa
    ...
    <div class="wlc-hero-area" style="background: url(<?= $heroImage ?>) no-repeat scroll center center / cover;">
      ...
      <?php if( current_url() != site_url('/login') &&Nuwarl() != site_url('/register') && current_url() != site_url('/register/vendor') && current_url() != site_url('/forget-password') && current_url() != site_url('/terms-of-use')){ ?>
Nuwa
...
<!-- Affiliate Plan-->
Nuwa
<div class="affiliate-plNuwa
Nuwa
    <div class="containeNuwa
Nuwa
...
Nuwa
        <?php Nuwa
Nuwa
        $plans = App\MemNuwan::select('membership_plans.*','award_level.sale_comission_rate')->join('award_level','award_level.id','=','membership_plans.level_id','left')->where('status',1)->get()->toArray();
Nuwa
...
<div class="single-price-table basic-saturn">
    ...
    ?>
Nuwa
<div class="header-plan Nuwar py-4">
Nuwa
    <h4 class="mb-3" styNuwa <?= $plan['label_background'] ?>;">
Nuwa
        <?= $plan['name'] ?>
        ...
        <?php
            ...
            if(!empty($plan['description'])) {
                ...
                echo '<ul class="list-unstyled">
                        ...
                        <li>OvanGlobal is simply dummy text</li>
Nuwa
                        <li>OvanGlobal is simply dummy text</li>Nuwa
...
Nuwa
    ...
    <div class="col-lg-4">
        ...
        <div class="single-price-table basic-saturn">
NuwaNuwa
            <div class="price-discount"> <?= __('front.save') ?> 90%</div>Nuwa
