<style>
	...
	#theme_section .table>tbody>tr>td,
	#theme_section .table>tfoot>tr>td,
	#theme_section .table>thead>tr>td,
	#menu_items_list.table>tbody>tr>td,
	#menu_items_list.table>tfoot>tr>td,
	#menu_items_list.table>thead>tr>td {
		padding: 5px 12px;
						...
						<div role="tabpanel">
							...
							<div class="tab-content mt-4">
								<div role="tabpanel" class="tab-pane" id="shipping_setting">
									<div class="card">
										<div class="card-header">
											<h6 class="m-0"><?= __('admin.shipping_charge') ?></h6>
										</div>
										<div class="card-body">
								...
								<div role="tabpanel" class="tab-pane" id="tax_setting">
									<div class="card">
										<div class="card-header">
											<h6 class="m-0"><?= __('admin.tax_charge') ?></h6>
										</div>
										<div class="card-body">
											<div class="mb-3">
								...
								<div role="tabpanel" class="tab-pane active col-8" id="store_main">
									...
									<div class="row mt-4">
										<div class="col mt-2">
											<div class="form-group">
												<div class="form-check form-switch">
													<input class="form-check-input store_mode" type="checkbox" <?= ((!isset($store['store_mode'])) || $store['store_mode'] == 'cart') ? 'checked' : ''; ?> id="switch" data-bs-on="On" data-bs-off="Off">
			...
			<button type="button" class="btn btn-danger btn-md remove-per-task-btn" style="position: absolute; top: 30px; right: 11px;"><i class="fa fa-trash"></i></button>
								...
								<div role="tabpanel" class="tab-pane" id="product_setting">
									<div class="col-12 commission_settings">
										...
										<div class="col-md-3 commission_product_settings">
											<fieldset>
										...
										<div class="col-md-3 commission_form_settings">
											<fieldset>
										...
										<div class="col-md-3 commission_form_settings">
											<fieldset>
												<legend class="form_commission_title h4">
													<?= __('Hoa Hồng Giới Thiệu') ?>
												</legend>
												<div class="mb-3">
													<label class="form-label"><?= __('Phần trăm hoa hồng') ?></label>
													<input name="formsetting[member_ship]" value="<?php echo $formsetting['member_ship']; ?>" class="form-control" type="number">
												</div>
											</fieldset>
										</div>
														...
														foreach ($bs_cards as $bsc) { ?>
															<tr>
																...
																<td style="width: 87px; padding: 5px 0px !important;">
																	...
																	<input type="hidden" name="store[bs_cards][bg_color_text][]" value="<?= $bsc->bg_color_text; ?>">
								...
								<div role="tabpanel" class="tab-pane" id="static_pages_section">
									...
									<div class="row">
										<div class="col-md-7">
											<div class="mb-3">
												<label class="form-label"><?= __('Hình ảnh giới thiệu 2') ?></label>
												<input class="form-control" type="file" name="store_aboutimage2">
											</div>
										</div>

										<div class="col-md-4 mt-3">
											<?php
											if (!empty($store['aboutimage2'])) {
											?>
												<img id="store_aboutimage3_container" style="width: 150px;" src="<?= base_url('assets/images/site/' . $store['aboutimage2'] . ''); ?>" class='img-fluid'>
											<?php
											} else {
											?>
												<img id="store_aboutimage2_container" style="width: 150px;" src="<?= base_url('assets/images/no_image_available.png'); ?>" class='img-fluid'>
											<?php
											}
											?>
										</div>
									...
									<div class="mb-3">
										<label class="form-label fw-bold"><?= __('Tiêu đề 1') ?></label>
										<input name="store[contact_text1]" id="contact_text1" class="form-control" value="<?= $store['contact_text1']; ?>">
									</div>
									<div class="mb-3">
										<label class="form-label"><?= __('Nội dung tiêu đề 1 ') ?></label>
										<textarea name="store[contact_content1]" id="contact_content1" class="form-control summernote"><?php echo $store['contact_content1']; ?></textarea>
									</div>
									<div class="mb-3">
										<label class="form-label fw-bold"><?= __('Tiêu đề 2') ?></label>
										<input name="store[contact_text2]" id="contact_text2" class="form-control" value="<?= $store['contact_text2']; ?>">
									</div>
									<div class="mb-3">
										<label class="form-label"><?= __('Nội dung tiêu đề 2') ?></label>
										<textarea name="store[contact_content2]" id="contact_content2" class="form-control summernote"><?php echo $store['contact_content2']; ?></textarea>
									</div>
									<div class="mb-3">
										<label class="form-label fw-bold"><?= __('Tiêu đề 3') ?></label>
										<input name="store[contact_text3]" id="contact_text3" class="form-control" value="<?= $store['contact_text3']; ?>">
									</div>
									<div class="mb-3">
										<label class="form-label"><?= __('Nội dung tiêu đề 3') ?></label>
										<textarea name="store[contact_content3]" id="contact_content3" class="form-control summernote"><?php echo $store['contact_content3']; ?></textarea>
									</div>
								</div>
								<!--static_pages_section-->
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="max-height:70vh; overflow-y:auto;">
					...
					<div class="mb-3">
						...
						<input id="bsc_bg_color_text" value="#000000" class="form-control jscolor-text" data-jscolor type="text">
					</div>
...
<script type="text/javascript">
	...
	$('.menu_on_front').on('change', function() {
		...
		$.ajax({
			...
			dataType: 'json',
			data: {
				'action': 'update_store_menu_on_front',
				status: status
			},
			success: function(json) {},
		})
	...
	$('.menu_on_front_blank').on('change', function() {
		...
		$.ajax({
			...
			dataType: 'json',
			data: {
				'action': 'update_store_menu_on_front_blank',
				status: status
			},
			success: function(json) {},
		})
			...
			if (result['bs_cards'].length > 0) {
				for (let index = 0; index < result['bs_cards'].length; index++) {
					...
					let new_row = `<tr>
							...
							<input type="hidden" name="store[bs_cards][bg_color_text][]" value="` + element.bg_color_text + `">
...
<script>
	...
	$(document).on('click', '.btn-bs-cards-form-modal', function() {
		...
		modal.find('#bsc_bg_color_text').val('#000000');
		...
		document.querySelector('#bsc_bg_color_text').jscolor.fromString('#000000');
	...
	$(document).on('click', '.btn-bs-cards-form-modal-edit', function() {
		...
		if (data.find('input[name="store[bs_cards][link_target][]"]').val() == 'true') {
			...
			$('#bsc_link_target').show();
		} else
			$('#bsc_link_target').hide();
		...
		modal.find('#bsc_bg_color_text').val(data.find('input[name="store[bs_cards][bg_color_text][]"]').val());
		document.querySelector('#bsc_bg_color').jscolor.fromString(data.find('input[name="store[bs_cards][bg_color][]"]').val());
		document.querySelector('#bsc_bg_color_text').jscolor.fromString(data.find('input[name="store[bs_cards][bg_color_text][]"]').val());
		modal.find('#store_bscimage').val('');
	...
	$(document).on('click', '#bs-cards-form-submit', function() {
		...
		if (modal.find('#bsc_title').val() == null || modal.find('#hs_title').val() == "") {
			...
			let new_row = `
				...
				<input type="hidden" name="store[bs_cards][bg_color_text][]" value="` + modal.find('#bsc_bg_color_text').val() + `">
	...
	$(document).on('change', '#pages_menu_section input[name="store_aboutimage2"]', function() {
		read_url(this, 'store_aboutimage2_container');
	});
		...
		$.ajax({
			...
			success: function(json) {
...

				{
					...
					// $('#contact_content1.summernote').summernote('code', '');
					// $('#contact_content1.summernote').html(escape($('#contact_content1.summernote').summernote('code', json.contact_content1)));
					//
					// $('#contact_content2.summernote').summernote('code', '');
					// $('#contact_content2.summernote').html(escape($('#contact_content2.summernote').summernote('code', json.contact_content2)));
					//
					// $('#contact_content3.summernote').summernote('code', '');
					// $('#contact_content3.summernote').html(escape($('#contact_content3.summernote').summernote('code', json.contact_content3)));
					//
					// $('#contact_text1.summernote').summernote('code', '');
					// $('#contact_text1.summernote').html(escape($('#contact_text1.summernote').summernote('code', json.contact_text1)));
					//
					// $('#contact_text2.summernote').summernote('code', '');
					// $('#contact_text2.summernote').html(escape($('#contact_text2.summernote').summernote('code', json.contact_text2)));
					//
					// $('#contact_text3.summernote').summernote('code', '');
					// $('#contact_text3.summernote').html(escape($('#contact_text3.summernote').summernote('code', json.contact_text3)));
				} else {
					$('#about_content.summernote').summernote('code', '');
					$('#contact_content.summernote').summernote('code', '');
					//  $('#contact_content1.summernote').summernote('code', '');
