<?php if ($products) { ?>
            ...
            <li class="ph-2 w-100">
                <div class="row mx-0">
                    ...
                    <div class="col-8 p-0 pl-2 text-left">
                        ...
                        <small><?= __('store.price') ?> : <?= c_format($product['branch_price'] + $product['variation_price']) ?></small>
                    </div>
    ...
    <ul>
        <li class="text-left"><b><?= __('store.subtotal') ?>:</b> <span class="float-right"><?= c_format($branch_sub_total) ?></span></li>
