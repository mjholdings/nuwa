                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane py-3 active show" id="commission_revenue_setting">
                            <div class="form-group">
                                    ...
                                    <script type="text/javascript">
                                        $("select.bonus_from_sales_personal_type").on("change", function() {
                                            ...
                                            if ($(this).val() == 'percentage')
                                                $("input[name='vendor[bonus_from_sales_personal_value]']").siblings('.currency-symbol').text('%');
                                            else
                                                $("input[name='vendor[bonus_from_sales_personal_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                        })
                                ...
                                <div class="form-group row mt-4">
                                    <label class="control-label col-sm-3">
                                        <?= __('Hoa hồng từ tiêu dùng Cá nhân') ?>
                                    </label>
                                    <label class="control-label col-sm-7">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['admin_consum_commission_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                    ...
                                    <script type="text/javascript">
                                        $("select.bonus_from_consum_personal_type").on("change", function() {
                                            ...
                                            if ($(this).val() == 'percentage')
                                                $("input[name='vendor[bonus_from_consum_personal_value]']").siblings('.currency-symbol').text('%');
                                            else
                                                $("input[name='vendor[bonus_from_consum_personal_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                        })
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_sales_direct_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_sales_direct_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_sales_direct_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_sales_direct_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                ...
                                <div class="form-group row mt-4">
                                    <label class="control-label col-sm-3">
                                        <?= __('Hoa hồng từ tiêu dùng Trực tiếp') ?>
                                    </label>
                                    <label class="control-label col-sm-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_consum_direct_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_consum_direct_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_consum_direct_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_consum_direct_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_sales_indirect_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_sales_indirect_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_sales_indirect_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_sales_indirect_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                ...
                                <div class="form-group row mt-4">
                                    <label class="control-label col-sm-3">
                                        <?= __('Hoa hồng từ tiêu dùng Gián tiếp') ?>
                                    </label>
                                    <label class="control-label col-sm-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_consum_indirect_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_consum_indirect_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_consum_indirect_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_consum_indirect_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_sales_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_sales_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_sales_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_sales_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                ...
                                <div class="form-group row mt-4">
                                    <label class="control-label col-sm-3">
                                        <?= __('Hoa hồng từ tiêu dùng Tuyến dưới') ?>
                                    </label>
                                    <label class="control-label col-sm-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_consum_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_consum_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_consum_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_consum_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_consum_team_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_consum_team_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_consum_team_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_consum_team_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                ...
                                <div class="form-group row mt-4">
                                    <label class="control-label col-sm-3">
                                        <?= __('Hoa hồng từ tiêu dùng Nhánh') ?>
                                    </label>
                                    <label class="control-label col-sm-7">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="toggle-container">
                                                <div class="percentage-value d-none">
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="currency-symbol mt-2"><?= $vendor['bonus_from_consum_branch_members_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                        ...
                                        <script type="text/javascript">
                                            $("select.bonus_from_consum_branch_members_type").on("change", function() {
                                                ...
                                                if ($(this).val() == 'percentage')
                                                    $("input[name='vendor[bonus_from_consum_branch_members_value]']").siblings('.currency-symbol').text('%');
                                                else
                                                    $("input[name='vendor[bonus_from_consum_branch_members_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                            })
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="market_vendor[bonus_recruitment_direct_type]" class="form-control">
                                                            ...
                                                            <option <?= ($market_vendor['bonus_recruitment_direct_type'] == 'percentage') ? 'selected' : '' ?> value="percentage"><?= __('admin.percentage') ?></option>
                                            ...
                                            <script type="text/javascript">
                                                $("select.bonus_recruitment_direct_type").on("change", function() {
                                                    ...
                                                    if ($(this).val() == 'percentage')
                                                        $("input[name='vendor[bonus_recruitment_direct_value]']").siblings('.currency-symbol').text('%');
                                                    else
                                                        $("input[name='vendor[bonus_recruitment_direct_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                                })
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="market_vendor[bonus_recruitment_indirect_type]" class="form-control">
                                                            <option value=""><?= __('admin.select_product_commission_type') ?></option>
                                                            <option <?= ($market_vendor['bonus_recruitment_indirect_type'] == 'percentage') ? 'selected' : '' ?> value="percentage"><?= __('admin.percentage') ?></option>
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="market_vendor[bonus_recruitment_downline_type]" class="form-control">
                                                            <option value=""><?= __('admin.select_product_commission_type') ?></option>
                                                            <option <?= ($market_vendor['bonus_recruitment_downline_type'] == 'percentage') ? 'selected' : '' ?> value="percentage"><?= __('admin.percentage') ?></option>
                                            ...
                                            <script type="text/javascript">
                                                $("select.bonus_recruitment_downline_type").on("change", function() {
                                                    ...
                                                    if ($(this).val() == 'percentage')
                                                        $("input[name='vendor[bonus_recruitment_downline_value]']").siblings('.currency-symbol').text('%');
                                                    else
                                                        $("input[name='vendor[bonus_recruitment_downline_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                                })
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-sm-5">
                                                    <div class="toggle-container">
                                                        <div class="percentage-value d-none">
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    <div class="currency-symbol mt-2"><?= $vendor['bonus_from_recruitment_direct_type'] == 'percentage' ? '%' : $CurrencySymbol ?></div>
                                            ...
                                            <script type="text/javascript">
                                                $("select.bonus_from_recruitment_direct_type").on("change", function() {
                                                    ...
                                                    if ($(this).val() == 'percentage')
                                                        $("input[name='vendor[bonus_from_recruitment_direct_value]']").siblings('.currency-symbol').text('%');
                                                    else
                                                        $("input[name='vendor[bonus_from_recruitment_direct_value]']").siblings('.currency-symbol').text('<?= $CurrencySymbol ?>');
                                                })
                                            ...
                                            <div class="row">
                                                <div class="col-sm-5">
                                                    <div class="form-group">
                                                        <div class="input-group mt-2">
                                                            <div class="input-group-prepend"><span class="input-group-text">
                                                                    <?= __('Số thành viên gián tiếp mời'); ?></span></div>
